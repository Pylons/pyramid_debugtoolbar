...
page.  Additionally, when an exception is raised by your application, an
interactive debugging console will appear.

.. warning:: The debug toolbar should never be enabled in a production
   environment or on a machine exposed directly to the internet.
